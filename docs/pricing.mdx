...
| **API Business** | $249.99/month | Everything in API Starter, 300 requests/minute, 10,000 requests/day, priority support, XLSX exports |
...
- **API Business** — the high-volume API tier for teams: everything in API Starter with 300 requests/minute and 10,000 requests/day, priority support, and XLSX exports. Starter customers upgrade from the billing portal (prorated immediately).
